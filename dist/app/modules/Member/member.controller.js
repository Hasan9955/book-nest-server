...
const getSingleMember = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield member_service_1.memberServices.getSingleMember(req.params.memberId);
    (0, response_1.default)(res, {
        statusCode: 200,
...
const updateMember = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield member_service_1.memberServices.updateMember(req.params.memberId, req.body);
    (0, response_1.default)(res, {
        statusCode: 200,
...
const deleteMember = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield member_service_1.memberServices.deleteMember(req.params.memberId);
    (0, response_1.default)(res, {
        statusCode: 200,
